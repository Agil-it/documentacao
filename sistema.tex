...
{\color{red}Aqui nesse capítulo devemos colocar toda a nossa base de estudo, ou seja todos nossos fundamentos teóricos como: Sistemas computacionais, Planejamento de Projetos e Analise de sistemas, UML, Design Patterns de UI, computação verde etc...  cada um deles dever ter no minimo 3 referencias}  Fiz uma gambiarra aqui, criem outro capítulo :-(
