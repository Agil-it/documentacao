...
\chapter{Introdução ao Documento}\label{cap_exemplos}

Para produzir seus produtos, a empresa Duas Rodas utiliza máquinas e equipamentos que auxiliam seus funcionários.
Esses equipamentos precisam passar por uma série de cuidados e estar em bom estado para o uso dos funcionários. Portanto, é de extrema importância para a Duas Rodas ter um controle e um bom fluxo de manutenções destes equipamentos, de modo que quebrem o menos possível e tenha o menor tempo de inatividade.\index{Introdução ao Documento}

% ---
\section{Tema}
% ---
O projeto consiste no desenvolvimento de um sistema de ordem de manutenção de equipamentos.
% ---
...
\begin{figure}[htb]
	...
	\begin{center}
	    \includegraphics[scale=0.32]{./Figuras/abntex2-modelo-img-grafico.pdf}
	\end{center}
